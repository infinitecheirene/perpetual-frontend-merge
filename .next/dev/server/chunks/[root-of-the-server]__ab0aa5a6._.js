...
"[project]/perpetual_merged/perpetual_frontend/app/api/trigger-news-email/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const emailData = {
            ...
            published_at: news.published_at ? new Date(news.published_at).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
            ...
            imageUrl: news.image ? `${process.env.NEXT_PUBLIC_IMAGE_URL}/${news.image}` : null,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$perpetual_merged$2f$perpetual_frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            message: 'Failed to send news emails',
            error: error.message
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ab0aa5a6._.js.map